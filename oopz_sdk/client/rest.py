...
class OopzRESTClient:
    ...
    @staticmethod
    def _build_v2_message_content(
        text: str, mention_list: list[dict[str, object]]
    ) -> str:
        if not mention_list:
            return text
    ...
    def copy_channel(
        ...
        return models.OperationResult(
            ok=True,
            message=str(payload.get("message") or "copied channel"),
    ...
    def edit_notification_settings(
        ...
        path = (
            "/person/v1/notification/v1/mobileEdit"
            if mobile
